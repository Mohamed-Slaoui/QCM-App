...
Route::middleware('auth')->controller(QCMController::class)->group(function(){
    Route::get('/qcm/pass-quiz/{id}', 'passQuiz')->name('pass-quiz');
    Route::post('/qcm/submit-quiz', 'submitQuiz')->name('submit-quiz');
});
